...
Devtron also shows all other apps available in your clusters. The apps are segregated into: 
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/infra-management/applications/other-app-listing.gif)
...
Apart from [internal helm apps created in Devtron](../deploy-chart/README.md), you can also view your external Helm app listing. Moreover, you can manage their deployments using Devtron. Read [Migrate Helm Release to Devtron](../../user-guide/creating-application/workflow/cd-pipeline.md#migrate-helm-release) to know more.
:::
