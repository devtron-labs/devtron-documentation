...
## Using Custom Runbooks

If you wish to create or modify a runbook beyond what AI generates automatically, Devtron allows full control over the runbook specification.
...
Refer [Approval Types](#approval-types) if you wish to take an action (approve/reject) on your new runbook.


### Add Runbook Spec

Runbook Actions are predefined operations that automate tasks within your Kubernetes or Devtron environment.  
They help teams execute standard changes (like resource updates) directly from the Devtron platform.
...
Each runbook follows a YAML structure that defines its metadata, tags, and executable steps. Use the YAML editor in Devtron to paste and modify this structure.
...
Check [Predefined Actions](#predefined-actions) to know how to write the steps in your runbook spec.
