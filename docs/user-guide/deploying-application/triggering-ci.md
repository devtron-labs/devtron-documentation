...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/devtron-apps/build-and-deploy/triggering-ci/select-material-new.jpg)
<center>Figure 1: Selecting Material</center>
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/devtron-apps/build-and-deploy/triggering-ci/trigger-build.jpg)
<center>Figure 2: Selecting Commit</center>
...
If you wish to pass runtime parameters for a build job, you can provide values before triggering the build. Thereafter, you can access those passed values by referencing the corresponding keys in the environment variable dictionary. For more details on parameter types, default values, file uploads, and optional variables, refer to [Runtime Parameters](./runtime-parameters.md).
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/devtron-apps/build-and-deploy/triggering-ci/build-logs.jpg)
<center>Figure 6: Logs</center>
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/devtron-apps/build-and-deploy/triggering-ci/build-source.jpg)
<center>Figure 7: Source</center>
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/devtron-apps/build-and-deploy/triggering-ci/tags-and-artifacts.jpg)
<center>Figure 8: Artifacts</center>
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/devtron-apps/build-and-deploy/triggering-ci/security-scan-report.jpg)
<center>Figure 9: Security</center>