...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/not-eligible-changes.jpg)
...
1. Go to **Application Management** → **Policies** → **Lock Deployment Configuration**.
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/lock-deployment-nav.jpg)
    <center>Figure 2: Navigating to Lock Deployment Configuration</center>

2. Click **+ Create Profile**; a new **Create Profile** page will open.

    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/lock-deployment-config.jpg)
    <center>Figure 3: Creating Profile</center>
...
4. (Optional) Click **Refer values.yaml** to check which keys you wish to lock.
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/values-yaml.jpg)
    <center>Figure 4: values.yaml File</center>
...
5. Enter the keys inside the editor on the left-hand side, e.g., `autoscaling.MaxReplicas`. Use [JSONpath expressions](https://goessner.net/articles/JsonPath/index.html) to enter specific keys, lists, or objects to lock.
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/autoscaling-lock.jpg)
    <center>Figure 5: Referring Values.YAML File for Locking Keys</center>
...
6. Click **Save Changes**. 
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/saving-locked-keys.jpg)
    <center>Figure 6: Saving Locked Keys</center>

7. Profile will be created, and available under the **Profiles** tab.

    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/confirmation.jpg)
    <center>Figure 7: Confirmation Dialog</center>
...
1. Go to **Application Management** → **Policies** → **Lock Deployment Configuration**.
     ...
     ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/lock-config-apply-profile.jpg)
    <center>Figure 8: Clicking 'Apply Profile'</center>
...
3. Select the profiles that you want to apply from the dropdown under **Select profiles to apply**; you can select multiple profiles.
     ...
     ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/lock-config-select-profile.jpg)
    <center>Figure 9: Selecting Lock Deployment Configuration Profile</center>
...
4. Select how you want to apply the profiles under **Apply selected profiles to deployment templates of**.
     ...
     1. **Specific deployment templates**: This option allows you to apply the lock deployment configuration profile to the deployment template(s) of specific application(s) within particular environment(s).
        ...
        ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/lock-config-specific-apps.gif)
        <center>Figure 10: Applying Profile to Specific Deployment Templates</center>
     ...
     2. **By match criteria**: This option allows you to use a combination of filters to create criteria. Lock deployment configuration profile will only apply to the deployment templates of the applications fulfilling your criteria (including existing and future ones).<br/>(Optional) You may also write a note for your other team members to understand the intent and context of your policy.
        ...
        ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/lock-config-match-criteria-use-case-1.gif)
        <center>Figure 11: Applying Profile By Match Criteria - Use Case 1</center>
     ...
     3. **Global (All deployment templates)**: This option allows you to apply the lock deployment configuration profile to all the existing and future deployment templates across all the applications. 
        ...
        ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/lock-config-global.jpg)
        <center>Figure 12: Applying Profile for all the Deployment Templates</center>
...
* User can hide/unhide the locked configurations as shown below.
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/hide-locked-keys.jpg)
    <center>Figure 13: Hiding Locked Keys</center>

### Editing Locked Configurations

:::info GUI/YAML Mode
<span className="inline-badge"><img src="https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/mode1.jpg" alt="GUI or YAML Mode" /></span> <br/>
...
* Let's assume the user edits one of the locked keys and saves the changes.

    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/change-locked-values.gif)
    <center>Figure 14: Editing Locked Keys</center>
...
* Let's assume the user edits a key that is not locked or adds a new key.
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/changing-allowed-values.gif)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/lock-config-edit-profiles.gif)
<center>Figure 19a: Editing Applied Profiles</center>

![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/lock-config-edit-match-criteria.gif)
<center>Figure 19b: Editing Match Criteria</center>

![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/lock-config-delete-applied-profile.gif)
<center>Figure 19c: Removing an Applied Profile</center>
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/lock-config-edit-profile.gif)
<center>Figure 20: Updating Lock Deployment Configuration File</center>
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/devtron-v2/app-management/policies/lock-dt/lock-config-delete-profile.gif)
<center>Figure 21: Deleting Lock Deployment Configuration File</center>
