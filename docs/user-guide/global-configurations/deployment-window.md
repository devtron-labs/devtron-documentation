...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/overview-deployment-v2.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/gc-deployment-window.jpg)
...
1. In the `Windows` tab, click **+ Add Window**.
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/add-window.jpg)
...
2. Give an appropriate name to your deployment window (e.g., *weekend restrictions*) and write a brief description that explains what the deployment window does. Refer [this section](#checking-deployment-window) to view the pages where the window name and description will appear.
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/name-description.jpg)
<center>Figure 4: Name and Description</center>

3. Choose a deployment window type, i.e., maintenance window or blackout window. 

    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/window-type-v2.jpg)
...
4. In your deployment window, make sure to choose the correct time zone (by default it is determined from the browser you use).
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/time-zone.jpg)
...
4. Click **+ Add duration**. 
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/add-duration.jpg)
...
5. The following options are available for you to enforce the deployment window:
    ...
    * **Monthly**: On or between days of the month, e.g., Day 1 (10:30 PM) to Day 2 (06:30 AM)
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/set-duration.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/start-end-date-v2.jpg)
...
6. You can also determine the users who can take actions (say deployment) even when restrictions are in place. These can be super-admins, specific users, both, or none.
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/user-selection.jpg)
...
7. Enter a display message to show the user whose deployment gets blocked, e.g., *Try deploying on Monday - Weekend deployment is not a best practice - Contact your Admin*. This will help the user understand the restriction better.
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/display-message.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/edit-window.gif)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/delete-window.gif)
...
1. Go to the **Apply To** tab and click the **No windows** dropdown next to the [application + environment] you wish to apply deployment window(s).
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/apply-window-single.gif)
...
1. If you wish to apply deployment windows to multiple applications and environments at once, use the checkbox.
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/select-apps.jpg)
<center>Figure 15: Selecting Deployment Pipelines</center>
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/filter-apply.jpg)
<center>Figure 16a: Using Filters</center>

    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/filter-apply-2.jpg)
<center>Figure 16b: Filtered Results</center>

2. On the floating widget, click **Manage Windows**.

    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/manage-window.jpg)
<center>Figure 17: Manage Windows</center>

3. Click the **Add Deployment Windows** dropdown to choose the deployment window(s).

    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/attach-windows.gif)
...
4. Use the **Review Changes** option to confirm the impacted environment(s) and click **Save**.
    ...
    ![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/review-environment.gif)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/remove-window-single.gif)
<center>Figure 20a: Removing Windows from Single Deployment Pipeline</center>

![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/remove-window.gif)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/deployment-window.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/app-details-deployment-win-v2.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/deployment-window-cm.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/hibernate-1-v2.jpg)
<center>Figure 24a: Hibernate App</center>

![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/hibernate-2.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/restart-workloads-1-v2.jpg)
<center>Figure 25a: Restart Workload</center>

![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/restart-workloads-2.jpg)
<center>Figure 25b: Selecting Workloads</center>

![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/restart-workloads-3.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/workload-deletion-1-v2.jpg)
<center>Figure 26a: Workload Deletion</center>

![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/workload-deletion-2.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/deployment-restricted.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/select-image.jpg)
<center>Figure 28a: Selecting an Image</center>

![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/blocked-deployment-dialog.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/deployment-log-v2.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/rollback-1.jpg)
<center>Figure 30a: Rollback Deployment</center>

![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/rollback-2.jpg)
<center>Figure 30b: Selecting Previously Deployed Image</center>

![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/rollback-3.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/pipeline-deletion-1.jpg)
<center>Figure 31a: Pipeline Deletion</center>

![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/pipeline-deletion-2.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/app-group-blackout.jpg)
...
![](https://devtron-public-asset.s3.us-east-2.amazonaws.com/images/global-configurations/deployment-window/ag-deploy.gif)
