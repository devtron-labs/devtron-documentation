...
| **k3s - Lightweight Kubernetes**   | <p>Create a cluster using [k3s - Lightweight Kubernetes](https://devtron.ai/blog/deploy-your-applications-over-k3s-lightweight-kubernetes-in-no-time/)</p><p><strong>Note</strong>: [Refer our documentation](../install/devtron-oss.md) for installing Devtron on Minikube, Microk8s, K3s, or Kind</p>  |
