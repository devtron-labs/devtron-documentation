...
{% hint style="danger" %}
### Warning
The license is bound to your Kubernetes cluster and cannot be transferred to another cluster. In case the cluster is deleted, you will not be able to claim freemium license on a new cluster. 
