...
With the **Freemium** plan of Devtron, you can access all the enterprise features beyond the open-source version limited to a single Kubernetes cluster. For your advanced and challenging use cases, you get comprehensive enterprise features including but not limited to:
